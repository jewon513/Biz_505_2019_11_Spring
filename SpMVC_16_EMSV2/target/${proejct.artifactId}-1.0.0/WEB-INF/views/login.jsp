...
/*
	div box에 image를 2개 가져오고 초기에는 2번째 이미지를 감추어둔다
*/
.naver_login{
...
$(function(){
	...
	<form method="POST" action="${rootPath}/member/login" class="login-form">
		...
		<div class="naver_login">
			<img alt="" src="${rootPath}/resources/images/naver_green.png" width="200px">
			<img alt="" src="${rootPath}/resources/images/naver_white.png" width="200px">
		</div>
