...
<script>
	$(function(){
		...
		// 특별한 이벤트가 없을 경우 페이지 로드가 끝나자마자 실행됨
		$.get("${rootPath}/bbs/cmt_list",
...
<article class="card">
	...
	<div class="card-footer bg-success text-white">CopyRight &copy; ${bbsVO.bbs_writer}</div>
...
<c:if test="${bbsVO.bbs_p_id == 0}">
	...
	<form:form action="${rootPath}/bbs/replay" modelAttribute="bbsVO">
		...
		<textarea name="bbs_content" id="bbs_content" placeholder="답글을 입력하세요" cols="" rows="10"></textarea>
