...
<form:form modelAttribute="emailVO" class="form-inline">
	...
	<div class="jewon-form-border">
		...
		<div class="form-group">
			...
			<form:input path="fromEmail" class="form-control col-sm-9" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<form:input path="sendDate" class="form-control col-sm-9" />
		</div>
		<div class="form-group">
			<label for="send_time">작성시각</label>
			<form:input path="sendTime" class="form-control col-sm-9" />
		</div>
		<div class="form-group">
			<label for="from_name">작성자</label>
			<form:input path="fromName" class="form-control col-sm-9" />
		</div>
		<div class="form-group">
